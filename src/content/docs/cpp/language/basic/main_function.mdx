...
import CWG from "@components/CWG.astro";
...
import WG21Paper from "@components/WG21Paper.astro";
...
|----|------------|-----------------------|------------------|
| <CWG id={1003} /> | C++98 | supported parameter names of `main` were overly restricted | all valid parameter names are supported |
| <CWG id={1886} /> | C++98 | the `main` function could be declared with a language linkage | prohibited |
| <CWG id={2479} /> | C++20 | the `main` function could be declared `consteval` | prohibited |
| <CWG id={2811} /> | C++98 | whether the `main` function is used after <WG21Paper paper="N3214" /> was unclear | it is considered used when named |
