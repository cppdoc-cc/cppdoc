...
The _entities_ of a C++ program are values, <Missing>objects</Missing>, <Missing>references</Missing>, <Missing>structured bindings</Missing>, <Missing>result bindings</Missing>, <Missing>functions</Missing>, <Missing>enumerators</Missing>, <Missing>types</Missing>, class members, <Missing>templates</Missing>, <Missing>template specializations</Missing>, <Missing>packs</Missing>, and <Missing>namespaces</Missing>. Preprocessor <Missing>macros</Missing> are not C++ entities.
