...
<DescList>
  ...
  <Desc kind="function template" autorevSince="C++17">
    <Fragment slot="item">
      <RevisionBlock noborder since="C++17" dir="v"><Missing>`ceil` (time_point)</Missing></RevisionBlock>
    </Fragment>
    converts a time_point to another, rounding up
  </Desc>
  <Desc kind="function" autorevSince="C++11">
    <Fragment slot="item">
      <RevisionBlock noborder since="C++11" dir="v"><Missing>`std::ceil`</Missing></RevisionBlock>
    </Fragment>
